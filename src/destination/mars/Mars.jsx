...
<p className="md:text-[82px] sm:text-[64px] text-[54px] sm:tracking-wider md:tracking-widest">MARS</p>
                ...
                <section
                    ...
                    <p className="text-[14px] md:text-[16px] mb-2">Avg. distance <br/> <span
                            className="text-[22px] md:text-[26px]">225 mil. km</span></p>
                    <p className="text-[14px] md:text-[16px]">Est. travel time <br/> <span
                            className="text-[22px] md:text-[26px]">9 months</span></p>
                </section>
    </div>
    </>
    )
