...
<p className="md:text-[82px] sm:text-[64px] text-[54px] sm:tracking-wider md:tracking-widest">TITAN</p>
                ...
                <section
                    ...
                    <p className="text-[14px] md:text-[16px] mb-2">Avg. distance <br/> <span
                            className="text-[22px] md:text-[26px]">1.6 bil. km</span></p>
                    <p className="text-[14px] md:text-[16px]">Est. travel time <br/> <span
                            className="text-[22px] md:text-[26px]">7 Years</span></p>
                </section>
    </div>
    </>
    )
