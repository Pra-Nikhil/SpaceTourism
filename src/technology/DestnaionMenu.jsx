  ...
  return (
    ...
    <nav id="menu"
        ...
        <div
         ...
         <a className="hover:border-gray-400 transition-all border-transparent border-b-[3px] pb-[16px] whitespace-pre" href="/Destination/moon"><span className="font-semibold mr-1">01  </span> DESTINATION</a>
            ...
            <a className="bg-transparent border-b-[3px] pb-[16px] whitespace-pre" href="/technology/terminology"><span className="font-semibold mr-1">03   </span>TECHNOLOGY</a>
        </div>
    </nav>
    </>
