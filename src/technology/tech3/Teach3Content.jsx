...
import Img1 from "./tech3.png";
import Img3 from "./img3.png"

export default function Teach3Content() {
  return (
    <div class="max-w-[1440px] overflow-y-visible min-h-[634px] max-[400px]:min-h-[560px] flex flex-col-reverse md:flex-row justify-center md:justify-between items-center xl:pb-16">
